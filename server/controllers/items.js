    ...
    const data = await Item.findByIdAndUpdate(
      request.params.id,
      {
        $set: {
          ...
          itemMaker: body.itemMaker,
          itemModel: body.itemModel,
          serialNumber: body.serialNumber,
          modelNumber: body.modelNumber,
          itemPowerType: body.itemPowerType,
          ...
          itemManualURL: body.itemManualURL,
          dateAcquired: body.dateAcquired,
          requiredSecondaryItem: body.requiredSecondaryItem,
          secondaryItemRelated: body.secondaryItemRelated,
          secondaryItemMaker: body.secondaryItemMaker,
          secondaryItemModelNumber: body.secondaryItemModelNumber,
          secondaryItemSerialNumber: body.secondaryItemSerialNumber,
          secondaryAttachmentsForItem: body.secondaryAttachmentsForItem,
          notes: body.notes
        }
      },
      {
