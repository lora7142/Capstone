      ...
      ${state.items
        .map(item => {
          ...
          <table class="reportStyle">
            ...
            <tr>
              <td><div class="updateButton" data-id="${item._id}" data-name="${item.name}" />Update Item</div></td>
...
export function addUpdateButtonHandler() {
  document.querySelectorAll(".updateButton").forEach(domElement => {
